...
# JOB 1: ERR12356072 to ERR12383269
START_SAMPLE="ERR12356072_trimmed"
END_SAMPLE="ERR12383269_trimmed"

echo "=== JOB 1: $START_SAMPLE to $END_SAMPLE (24 samples) ==="
