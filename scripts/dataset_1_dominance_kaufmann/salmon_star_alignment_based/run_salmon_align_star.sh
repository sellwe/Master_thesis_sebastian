...
#SBATCH --ntasks=20
#SBATCH -t 48:00:00
#SBATCH -J salmon_alignment_based
...
# Paths
TRANSCRIPTS="/proj/naiss2023-6-65/Sebastian/data/reference_genome_c_mac/transcripts_unfiltered.fa"
STAR_TRANS_BAM_DIR="/proj/naiss2023-6-65/Sebastian/data/rna_data_kaufmann_2024_dominance/results/star_transcriptome_bam"
OUT_DIR="/proj/naiss2023-6-65/Sebastian/data/rna_data_kaufmann_2024_dominance/results/salmon_alignment_based_quant"
