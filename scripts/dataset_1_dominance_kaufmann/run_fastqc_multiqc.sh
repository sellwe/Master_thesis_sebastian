...
OUT_DIR="/proj/naiss2023-6-65/Sebastian/data/rna_data_kaufmann_2024_dominance/results/fastqc_multiqc"


# Run FastQC

echo "Running FastQC on all FASTQ files..."
fastqc -t 8 -o "$OUT_DIR" "$DATA_DIR"/*.fastq.gz
